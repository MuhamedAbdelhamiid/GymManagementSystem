...
namespace GymManagementDAL.Migrations
{
    ...
    [Migration("20251029182010_PhotoNonNullableModification")]
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("EgyptianPhoneValidConstraint", "Phone LIKE '01[0,1,2,5][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Trainer", b =>
                {
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            t.HasCheckConstraint("EgyptianPhoneValidConstraint", "Phone LIKE '01[0,1,2,5][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'")
                                .HasName("EgyptianPhoneValidConstraint1");

                            t.HasCheckConstraint("EmailValidConstraintFormat", "Email like '_%@_%._%'")
                                .HasName("EmailValidConstraintFormat1");
                        });
                });

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EgyptianPhoneValidConstraint", "Phone LIKE '01[0,1,2,5][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                    table.CheckConstraint("EmailValidConstraintFormat", "Email like '_%@_%._%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EgyptianPhoneValidConstraint1", "Phone LIKE '01[0,1,2,5][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'");
                    table.CheckConstraint("EmailValidConstraintFormat1", "Email like '_%@_%._%'");
                });
